import pufferVestImg from "@/assets/puffer-vest.jpg";
import miniSkirtImg from "@/assets/pleated-mini-skirt.jpg";
import pixelImg from "@/assets/phone-pixel-style.jpg";
import nothingPhoneImg from "@/assets/phone-transparent.jpg";
import towerFanImg from "@/assets/tower-fan.jpg";
import chargePadImg from "@/assets/charge-pad-trio.jpg";
import miniKettleImg from "@/assets/mini-kettle.jpg";
import storageBinsImg from "@/assets/storage-bins.jpg";
import extensionBoardImg from "@/assets/extension-board.jpg";
...
export const products: Product[] = [
  ...
  { id: "p18", name: "Puffer Vest", brand: "Uniqlo", price: 3999, oldPrice: 4999, category: "clothes", image: pufferVestImg, rating: 4.6, description: "Ultralight insulated vest for layering." },
  ...
  { id: "p31", name: "Pleated Mini Skirt", brand: "Mango", price: 1899, category: "clothes", image: miniSkirtImg, rating: 4.4, description: "Soft-pleat A-line skirt with elastic waist." },
  { id: "p32", name: "Cropped Trucker Jacket", brand: "Tommy Hilfiger", price: 4499, category: "clothes", image: u("photo-1516257984-b1b4d707412e"), rating: 4.5, description: "Mid-wash cropped trucker with chest pockets." },
  ...
  { id: "p7", name: "Pixel 8 Pro", brand: "Google", price: 106999, category: "mobiles", image: pixelImg, rating: 4.7, description: "Tensor G3 with the best computational photography." },
  { id: "p21", name: "OnePlus 12", brand: "OnePlus", price: 64999, oldPrice: 69999, category: "mobiles", image: u("photo-1567581935884-3349723552ca"), rating: 4.6, description: "Hasselblad cameras, 100W fast charging.", tag: "Sale" },
  { id: "p22", name: "Redmi Note 13 Pro+", brand: "Xiaomi", price: 31999, category: "mobiles", image: u("photo-1598327105666-5b89351aff97"), rating: 4.4, description: "200MP camera, AMOLED 120Hz display." },
  { id: "p23", name: "Realme GT 5 Pro", brand: "Realme", price: 49999, category: "mobiles", image: u("photo-1585060544812-6b45742d762f"), rating: 4.5, description: "Snapdragon 8 Gen 3 flagship killer." },
  { id: "p33", name: "Nothing Phone (2)", brand: "Nothing", price: 44999, oldPrice: 49999, category: "mobiles", image: nothingPhoneImg, rating: 4.6, description: "Glyph interface, Snapdragon 8+ Gen 1.", tag: "Hot" },
  ...
  { id: "p9", name: "Galaxy Tab S9 FE", brand: "Samsung", price: 36999, category: "tablets", image: u("photo-1585790050230-5dd28404ccb9"), rating: 4.5, description: "10.9\" LCD, S Pen included, water resistant." },
  ...
  { id: "p25", name: "MatePad 11.5", brand: "Huawei", price: 27999, category: "tablets", image: u("photo-1587033411391-5d9e51cce126"), rating: 4.3, description: "120Hz display with M-Pencil bundled." },
  ...
  { id: "p27", name: "Pavilion Aero 13", brand: "HP", price: 74999, oldPrice: 84999, category: "laptops", image: u("photo-1593642632823-8f785ba67e45"), rating: 4.4, description: "Sub-1kg with Ryzen 7 and 16GB RAM.", tag: "Sale" },
  ...
  { id: "p15", name: "QC Ultra Headphones", brand: "Bose", price: 36900, category: "accessories", image: u("photo-1505740420928-5e560c06d30e"), rating: 4.7, description: "Immersive spatial audio with QuietComfort tech." },
  ...
  { id: "p29", name: "Charge Pad Trio", brand: "Anker", price: 4999, category: "accessories", image: chargePadImg, rating: 4.3, description: "3-in-1 wireless charging pad." },
  ...
  // COLLEGE
  { id: "c1", name: "Memory Foam Pillow Set", brand: "Sleepyhead", price: 1799, oldPrice: 2499, category: "college", image: u("photo-1584100936595-c0654b55a2e2"), rating: 4.6, description: "Pack of 2 cooling-gel pillows for hostel beds.", tag: "Hostel pick" },
  { id: "c2", name: "Mini Electric Kettle 0.6L", brand: "Pigeon", price: 899, category: "college", image: miniKettleImg, rating: 4.5, description: "Compact kettle — perfect for instant noodles." },
  { id: "c3", name: "Study Desk Lamp", brand: "Philips", price: 1299, category: "college", image: u("photo-1507473885765-e6ed057f782c"), rating: 4.7, description: "LED dimmable lamp with USB charging port." },
  { id: "c4", name: "Stackable Storage Bins", brand: "Ikea", price: 1499, category: "college", image: storageBinsImg, rating: 4.4, description: "Set of 3 collapsible hostel storage boxes." },
  ...
  { id: "c7", name: "Foldable Cloth Hangers x10", brand: "Kuber", price: 349, category: "college", image: u("photo-1558769132-cb1aea458c5e"), rating: 4.2, description: "Space-saving anti-skid hangers for hostel wardrobes." },
  ...
  { id: "c10", name: "Mini Iron Travel", brand: "Bajaj", price: 749, category: "college", image: u("photo-1489274495757-95c7c837b101"), rating: 4.2, description: "Compact dry iron, fits in any drawer." },
  { id: "c11", name: "Extension Board 4-Socket", brand: "Goldmedal", price: 549, category: "college", image: extensionBoardImg, rating: 4.6, description: "Surge-protected board with 2m cord." },
  ...
  { id: "c14", name: "Tower Fan Slim", brand: "Havells", price: 3499, category: "college", image: towerFanImg, rating: 4.3, description: "Quiet 3-speed tower fan for small rooms." },
];
